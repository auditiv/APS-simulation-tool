...
class HomeController(@Autowired var todoItemService: TodoItemService, var simService: SimulationService) {
    ...
    public fun index(redirectAttributes: RedirectAttributes): ModelAndView{
        ...
        modelAndView.addObject("algorithms", listOf("oref0", "BasicBasal","Others"))
        modelAndView.addObject("sensors", listOf("Dexcom G5", "Dexcom G6","Ideal-CGM-Sensor"))
        modelAndView.addObject("insulinPumps", listOf("IdealInsulinPump", "Others"))
