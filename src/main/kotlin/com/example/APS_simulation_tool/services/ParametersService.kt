...
class ParametersService(@Autowired var settingParametersRepo: ParametersRepository) {
    ...
    fun createParametersFromParametersView(paramView: ParametersView): ParametersTable {
        return ParametersTable(
            SerializeHelper.serializeListOfParameter(paramView.virtualPatientParams),
    ...
    fun createDefaultParameters(settings: ComponentsTable): ParametersTable {
        ...
        if (settings.virtualPatient == "UVA/Padova") {
            parametersUvaPadova = listOf(
                ...
                Parameter(
                    ...
                    "Double",
                    "1/min",
                    "Rate at which a substance is absorbed into the bloodstream"
                ),
                ...
                Parameter(
                    ...
                    "Double",
                    "Unitless",
                    "Coefficient representing insulin action on glucose utilization"
                ),
                Parameter(
                    "d",
                    0.32294,
                    "Double",
                    "Unitless",
                    "Coefficient representing the rate of insulin degradation"
                ),
                ...
                Parameter(
                    ...
                    "Double",
                    "mg/dL/min",
                    "Maximum rate at which insulin can act to lower blood glucose"
                ),
                Parameter(
                    "Km0",
                    260.89,
                    "Double",
                    "mg/dL",
                    "Constant describing insulin sensitivity in glucose utilization"
                ),
                ...
                Parameter(
                    ...
                    "Double",
                    "Unitless",
                    "Parameter describing the effect of insulin on glucose utilization"
                ),
                ...
                Parameter(
                    ...
                    "Double",
                    "1/min",
                    "Rate constant for insulin's effect on liver glucose production"
                ),
                ...
                Parameter(
                    ...
                    "Double",
                    "1/min",
                    "Rate constants describing glucagon's effect on glucose production"
                ),
                Parameter(
                    "kp3",
                    0.023253,
                ...
                Parameter(
                    ...
                    "Double",
                    "Unitless",
                    "Function describing modifications in glucagon action based on other factors"
                ),
                ...
                Parameter(
                    ...
                    "Double",
                    "mg/dL",
                    "Basal glucose level below which certain physiological responses are triggered"
                ),
                ...
                Parameter(
                    ...
                    "Double",
                    "mg/dL/min",
                    "Basal rate at which insulin can act to lower blood glucose"
                ),
                Parameter(
                    "Rdb",
                    3.3924,
                    "Double",
                    "U/min",
                    "Baseline rate at which drugs (like insulin) are absorbed into the bloodstream"
                ),
                ...
                Parameter(
                    ...
                    "Double",
                    "g/kg/day",
                    "Baseline rate of protein breakdown in the body"
                ),
                ...
                Parameter(
                    ...
                    "Double",
                    "Unitless",
                    "First steady state subcutaneous insulin concentration"
                ),
                Parameter(
                    "isc2ss",
                    93.2258828462,
                    "Double",
                    "Unitless",
                    "Second steady state subcutaneous insulin concentration"
                ),
        ...
        if (settings.sensor == "Ideal-CGM-Sensor") {
            parametersSensor = listOf(
                Parameter("samplingtime", 5, "Integer", "min", "CGM sampling time interval in minutes"),
        ...
        if (settings.insulinPump == "Ideal-Insulin-Pump") {
            parametersInsulinPump = listOf(
                Parameter(
                    ...
                    type = "Double",
                    unit = "",
                    description = "injection error, must be greater than zero"
                ),
            )
        }
        ...
        if (settings.meals == "1") {
            parametersMeals = listOf(
                MealParameter(
                    "Breakfast",
                    "First Meal Time of the Day in carbs",
                    "carbs in grams",
                    LocalTime.of(8, 0),
                    carbs = 50
                ),
        ...
        if (settings.meals == "2") {
            parametersMeals = listOf(
                ...
                MealParameter(
                    "Lunch",
                    "Main Meal Time of the Day in carbs",
                    "carbs in grams",
                    LocalTime.of(12, 0),
                    carbs = 50
                ),
        ...
        if (settings.meals == "3") {
            parametersMeals = listOf(
                ...
                MealParameter(
                    "Dinner",
                    "Last Meal Time of the Day in carbs",
                    "carbs in grams",
                    LocalTime.of(18, 0),
                    carbs = 50
                )
    ...
    fun saveParameters(s: ParametersTable, id: Long): ParametersTable {
        var sim = ParametersTable(
            s.virtualPatientParams, s.algorithmParams, s.sensorParams, s.insulinPumpParams,
