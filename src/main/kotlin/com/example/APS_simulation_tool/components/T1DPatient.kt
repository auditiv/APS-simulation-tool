...
class PatientHelper {
    fun createInitialConditionsForPatient(): DoubleArray {
        val ys = doubleArrayOf(
            0.0, 0.0, 0.0, 247.621836, 176.506559902, 4.697517762, 0.0, 97.554, 97.554, 3.19814917262, 57.951224472,
